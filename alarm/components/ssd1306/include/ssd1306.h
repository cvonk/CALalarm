...
void ssd1306_display_text(SSD1306_t * const dev, int const page, char const * const text, int const text_len, bool const invert);
void  ssd1306_display_text_x3(SSD1306_t * const dev, int const page, char const * const text, int const text_len, bool const invert);
