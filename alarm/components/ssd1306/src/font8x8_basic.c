...
// 8-bit columns from left to right
// link symbol created using Windows Bitmap and LCD Assistant, http://en.radzio.dxp.pl/bitmap_converter/
uint8_t const font8x8_basic_tr[128][8] = {
    ...
    { 0x3C, 0x7E, 0xC7, 0x83, 0x83, 0x3B, 0x7B, 0xC3 },   // U+0003 (link leftpart),
    { 0xC7, 0xDE, 0xDC, 0xC1, 0xC1, 0xE3, 0x7E, 0x3C },   // U+0004 (link leftpart)
    ...
    {
        0b00000000,  // this all makes U+0022 (")
        0b00000011,
        0b00000011,
        0b00000000,
        0b00000011,
