...
#define CONFIG_CLOCK_OTA_FIRMWARE_URL "https://coertvonk.com/svonk/calenderclock/calenderclock.bin"
#define CONFIG_CLOCK_RESET_PIN 0
#define CONFIG_CLOCK_RESET_SECONDS 3
